 ...
 */
class Version20171206154721 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\'');
        ...
        $this->addSql('ALTER TABLE order_product CHANGE order_id order_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\'');
